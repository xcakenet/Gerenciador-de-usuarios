...
import { LayoutDashboard, Users, FileUp, ShieldCheck, Database, Settings, Menu, X } from 'lucide-react';
      ...
      `}>
        ...
        <div className="p-4 border-t border-slate-800">
          <div className="bg-slate-800/50 rounded-xl p-4">
            <p className="text-[10px] uppercase font-bold text-slate-500 mb-1 tracking-wider">Perfil</p>
            <p className="text-sm font-semibold text-white">Administrador MySQL</p>
          </div>
        </div>
      </aside>
